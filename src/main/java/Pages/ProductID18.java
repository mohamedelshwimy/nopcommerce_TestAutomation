...
public class ProductID18 {
    private WebDriver driver;
    public ProductID18(WebDriver driver) {
        this.driver = driver;
    }

    //Locators
    private By productQnty= By.id("product_enteredQuantity_18");
    private By addToCart = By.id("add-to-cart-button-18");
